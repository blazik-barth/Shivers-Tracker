...
function corridor_from_maze()
    return (maze_from_egypt() or maze_from_inventions()) and has("ThreeElKey")
end
...
-- Strange Inventions access requires Egypt or corridor access in the first place, so we disregard it
function has_maze_access()
    return maze_from_corridor() or maze_from_egypt()
end
